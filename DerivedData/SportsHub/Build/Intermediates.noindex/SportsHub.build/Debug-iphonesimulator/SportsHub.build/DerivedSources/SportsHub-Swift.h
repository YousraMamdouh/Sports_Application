...
#ifndef SPORTSHUB_SWIFT_H
#define SPORTSHUB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SportsHub",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SportsHub11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified sportsCollectionView;
- (void)viewDidLoad;
...
@interface LeaguesTableViewController : UIViewController
@property (nonatomic, weak) IBOutlet AnimationView * _Null_unspecified animationView;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
...
@interface LeaguesTableViewController (SWIFT_EXTENSION(SportsHub)) <UISearchBarDelegate>
- (void)searchBar:(UISearchBar * _Nonnull)searchBar textDidChange:(NSString * _Nonnull)searchText;
@end


@interface LeaguesTableViewController (SWIFT_EXTENSION(SportsHub)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9SportsHub10PlayerCell")
@interface PlayerCell : UICollectionViewCell
- (void)awakeFromNib;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified backView;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified playerImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerType;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerNumber;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerName;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerAge;
...
SWIFT_CLASS("_TtC9SportsHub13SceneDelegate")
...
- (void)awakeFromNib;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified sportLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified sportImage;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9SportsHub13TableViewCell")
@interface TableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified leagueImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified leagueLabel;
- (void)awakeFromNib;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified backView;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
...
@interface TeamDetailsViewController (SWIFT_EXTENSION(SportsHub)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
